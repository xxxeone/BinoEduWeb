...
const enterprises = [
	{
		...
		image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&h=600&fit=crop&crop=faces",
	},
	{
		name: "丰田汽车总部",
		description:
			"世界五百强 – 2025年第15名；精益生产（Lean）与持续改善（Kaizen）的世界级文化；进入电动车时代仍稳居销售与营收高位。",
		tags: ["精益生产", "Kaizen 改善", "现场主义"],
		highlights: ["TPS 实地学习：看板/节拍/标准作业", "与一线管理者交流持续改善机制"],
		image: "https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=800&h=600&fit=crop&crop=faces",
	},
	{
		name: "冈山健康餐饮集团",
		description:
		...
		image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&h=600&fit=crop&crop=faces",
	},
	{
		name: "川村义肢",
		description:
		...
		image: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&h=600&fit=crop&crop=faces",
	},
	{
		name: "梅守寿司",
		description:
		...
		image: "https://images.unsplash.com/photo-1579952363873-27d3bfad9c0d?w=800&h=600&fit=crop&crop=faces",
	},
];
